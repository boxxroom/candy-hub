...
class SideMenu extends Menu
{
    public function __construct()
    {
        $this->navItems = [
            ...
            new NavItem('titles.attribute-groups', route('hub.attributes.index'), 'attribute-groups'),
            new NavItem('titles.product-families', route('hub.attributes.index'), 'product-families'),
