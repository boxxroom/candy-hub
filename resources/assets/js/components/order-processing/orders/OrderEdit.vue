                                            ...
                                            <tfoot>
                                                <template v-if="order.discounts.data.length">
                                                    <tr v-for="discount in order.discounts.data">
                                                        ...
                                                        <td class="text-danger" v-html="currencySymbol(-discountTotal)">
                                                        </td>
                                                    </tr>
                                                </template>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td v-html="currencySymbol(order.tax)"></td>
                                                </tr>
                                                <tr>
                                                    <td colspan="5"></td>
                                                ...
                                                <tr v-for="line in order.lines.data">
                                                    ...
                                                    <td>
                                                        <template v-if="line.discount">
                                                            <span class="text-danger" v-html="currencySymbol(-line.discount)"></span>
                                                        </template>
                                                        <template v-else>
                                                            -
                                                        </template>
                                                    </td>
                                                    <td><span v-if="line.tax">VAT @ {{ line.tax_rate }}%</span><span v-else>-</span></td>
                                                    <td v-html="currencySymbol(line.tax)"></td>
                                                    <td v-html="currencySymbol(line.line_amount)"></td>
                                                </tr>
                                            </tbody>
                                        </table>
